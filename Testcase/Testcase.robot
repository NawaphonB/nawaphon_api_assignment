...
TC-004 Verify that create asset API can work correctly 
    ...
    Call Create Asset API   ${TC_004.asset_id}    ${TC_004.asset_name}   ${TC_004.asset_type}   ${TC_004.asset_inuse}
    Verified result by calling get API      ${TC_004.asset_id}    ${TC_004.asset_name}   ${TC_004.asset_type}   ${TC_004.asset_inuse}
    Reset Data by delete asset      ${TC_004.asset_id}
...
TC-006 Verify that modify asset API can work correctly
    ...
    Call Create Asset API   ${TC_006.asset_id}    ${TC_006.asset_name}   ${TC_006.asset_type}   ${TC_006.asset_inuse}
    Verified result by calling get API      ${TC_006.asset_id}    ${TC_006.asset_name}    ${TC_006.asset_type}   ${TC_006.asset_inuse}
    Call Modify Asset API   ${TC_006.asset_id_mod}    ${TC_006.asset_name_mod}    ${TC_006.asset_type_mod}   ${TC_006.asset_inuse_mod}
    Verified result by calling get API      ${TC_006.asset_id_mod}    ${TC_006.asset_name_mod}    ${TC_006.asset_type_mod}    ${TC_006.asset_inuse_mod}
    Reset Data by delete asset      ${TC_006.asset_id_mod}

TC-007 Verify that delete asset API can work correctly
    [Tags]  Test7   e2e
    #call delete asset 
    #call GET to check that asset has been deleted
    Call Create Asset API   ${TC_007.asset_id}    ${TC_007.asset_name}   ${TC_007.asset_type}  ${TC_007.asset_inuse}   
    Verified result by calling get API      ${TC_007.asset_id}    ${TC_007.asset_name}   ${TC_007.asset_type}  ${TC_007.asset_inuse}
    Call Delete Asset API   ${TC_007.asset_id}
    Verified delete result by calling get API   ${TC_007.asset_id}    ${TC_007.asset_name}   ${TC_007.asset_type}  ${TC_007.asset_inuse}
